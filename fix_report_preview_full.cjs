...
// I will just use string splits and splices to insert the missing parts!
// I'll search for the first part of what's broken and the part after it.

// Let's replace the whole block starting from `          <div className="space-y-4 font-serif text-lg leading-relaxed text-black">`
// up to `            <div className="pl-4 space-y-6">` where it resumes properly.

const startStr = `          <div className="space-y-4 font-serif text-lg leading-relaxed text-black">\n            <TocItem title="DAFTAR ISI" page="I" id="daftar-isi" isBold />\n            <TocItem title="DAFTAR GAMBAR" page="II" id="daftar-gambar" isBold />\n            <TocItem title="DAFTAR KODE PROGRAM" page="III" id="daftar-kode-program" isBold />`;
const endStr = `            <div className="pl-4 space-y-6">\n              <h2 id="alat-bahan" className="font-bold text-lg scroll-mt-8 text-black outline-none" contentEditable suppressContentEditableWarning>A. Alat dan Bahan:</h2>`;

const replacement = `          <div className="space-y-4 font-serif text-lg leading-relaxed text-black">
            <TocItem title="DAFTAR ISI" page="I" id="daftar-isi" isBold />
            <TocItem title="DAFTAR GAMBAR" page="II" id="daftar-gambar" isBold />
            <TocItem title="DAFTAR KODE PROGRAM" page="III" id="daftar-kode-program" isBold />
